...
function saveHighScore() {
  var endingScore = parseInt(score.innerHTML, 10)
  var highScore = (localStorage.getItem('highScore'), 10)
  if (endingScore > highScore) {
  localStorage.setItem('highScore', endingScore)
  }
}
